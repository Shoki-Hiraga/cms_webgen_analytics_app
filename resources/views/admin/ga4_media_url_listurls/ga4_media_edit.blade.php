<x-app-layout>
    ...
    <div class="form-container">
        <form action="{{ route('admin.ga4_media_url_listurls.update', $url->id) }}" method="POST">
            @csrf
            @method('PUT')
        ...
        <form action="{{ route('admin.ga4_media_url_listurls.destroy', $url->id) }}" method="POST" style="margin-top: 20px;">
            @csrf
            @method('DELETE')
